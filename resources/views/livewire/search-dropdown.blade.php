<div class="relative mt-3 md:mt-0" x-data="{ isOpen: true }" @click.away="isOpen = false">
    ...
    <div class="absolute top-0">
        <i class="fa fa-search w-4 text-gray-500 mt-2 ml-2" aria-hidden="true"></i>
    </div>
            ...
            @if ($searchResults->count() > 0)
                <ul>
                    @foreach ($searchResults as $result )
                        <li class="border-b hover:bg-gray-700">
                            <a class="hover:bg-gray-700 flex px-3 py-3 items-center"
